...
<script runat="server">
	...
	{
        return Portal.QLDT.Secure.Provider.PolicyProviderManager.Provider.IsLogin();
	}
	...
	public override void SetConfig()
	{
        ...
        BaseUrl = Core.Common.AppSettings.GetString(Core.Common.Constants.StorageFolder);
		...
		Thumbnails.Url = BaseUrl + "news/_thumbs/";
		if ( BaseDir != "" ) {
            Thumbnails.Dir = BaseDir + "news/_thumbs/";
		}
